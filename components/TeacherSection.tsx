...
const TeacherSection: React.FC = () => {
  ...
  return (
    <section className="bg-combo-yellow dark:bg-yellow-500 py-20 md:py-24 transition-colors duration-300">
      <div className="container mx-auto px-6">
        <h2 id="professores" className="text-4xl md:text-5xl font-extrabold text-center text-combo-red dark:text-red-700 mb-12 md:mb-16">
          Conheça Seu <span className="text-white dark:text-gray-900">Professor</span>
        </h2>
